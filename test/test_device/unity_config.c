...
void unity_usart2_init(void)
{
	...
	MODIFY_REG(GPIOA->AFR[0], GPIO_AFRL_AFRL2|GPIO_AFRL_AFRL3, GPIO_AFRL_AFRL2_2 | GPIO_AFRL_AFRL2_1 | GPIO_AFRL_AFRL2_0 | GPIO_AFRL_AFRL3_2 | GPIO_AFRL_AFRL3_1 | GPIO_AFRL_AFRL3_0); // set PA2 to AF7 (USART2_TX) and PA3 to AF7 (USART2_RX)
